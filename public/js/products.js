function getallproducts(params=null) {
    var settings = {
        "async": true,
        "crossDomain": true,
       "url":"http://localhost/reagan/api/products/index",
        "method": "GET",
        "data": {
    ...
    <article class="product wow fadeInRight" style="visibility: visible; animation-name: fadeInRight;">
        ...
        <div class="product-button-wrap">
            ...
            <div class="product-button"><a class="button button-primary button-zakaria fl-bigmug-line-shopping202" href="javascript:void(0)" onclick="deleteproduct(${entry.id})"></a></div>
        </div>
    </article>
    </div>`;
    }); 
...
function getbycategory(param) { 
    var settings = {
        "async": true,
        "crossDomain": true,
       "url":"http://localhost/reagan/api/products/category/"+param,
        "method": "GET",
        "data": {
            // "apiKey": "51e3d490e2da412c988237f19087ad66",
           // "newsSource": "abc-news-au"
